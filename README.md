...
- **Selection-to-agent context** — release after selecting terminal text to reveal a bottom-right "Launch agent" pill; choose Claude, Codex, or Gemini in a centered modal, review the selected context, enter wrapped multiline instructions, and launch a new agent in the selected terminal's working directory with the selection appended as context
