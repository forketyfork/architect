...
- **Interactive Control**:
  ...
  - Open the git worktree picker with the T pill (left of ?) or ⌘O; it refreshes each time you open it, lists worktrees discovered from git metadata, and shows paths relative to the primary worktree; hit ⌘0–⌘9 to relaunch the focused terminal in that worktree
